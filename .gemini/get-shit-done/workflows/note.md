...
- **Global scope**: `/home/joao/hrtech/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/joao/hrtech/.gemini/notes/`)
...
2. Glob `/home/joao/hrtech/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/home/joao/hrtech/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/joao/hrtech/.gemini/notes/` — works in any directory
